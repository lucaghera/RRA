 ...
 * <ul>
 *   <li>{@link org.rra.adaptationModel.adaptationModelDSL.impl.AVGImpl#getMeasurement <em>Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AVGImpl extends MinimalEObjectImpl.Container implements AVG
{
  /**
  ...
  {
    return AdaptationModelDSLPackage.Literals.AVG;
  }
  ...
  public EList<Import> getMeasurement()
  {
    if (measurement == null)
    {
      measurement = new EObjectResolvingEList<Import>(Import.class, this, AdaptationModelDSLPackage.AVG__MEASUREMENT);
    }
    return measurement;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AdaptationModelDSLPackage.AVG__MEASUREMENT:
