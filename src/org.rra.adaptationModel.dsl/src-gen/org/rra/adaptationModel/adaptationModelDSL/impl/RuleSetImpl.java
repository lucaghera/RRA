...
public class RuleSetImpl extends MinimalEObjectImpl.Container implements RuleSet
{
   ...
   * @ordered
   */
  protected EList<RuleWithPriority> rules;
   ...
   * @generated
   */
  public EList<RuleWithPriority> getRules()
  {
    if (rules == null)
    {
      rules = new EObjectContainmentEList<RuleWithPriority>(RuleWithPriority.class, this, AdaptationModelDSLPackage.RULE_SET__RULES);
    }
    return rules;
  }
