...
/**
 * This is the item provider adapter for a {@link org.rra.cdmModel.ContextDependentMeasurement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextDependentMeasurementItemProvider
	 ...
	 * @generated
	 */
	public ContextDependentMeasurementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextDependentMeasurement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextDependentMeasurement_name_feature", "_UI_ContextDependentMeasurement_type"),
				 CDMModelPackage.Literals.CONTEXT_DEPENDENT_MEASUREMENT__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ContextDependentMeasurement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ContextDependentMeasurement_type") :
			getString("_UI_ContextDependentMeasurement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ContextDependentMeasurement.class)) {
