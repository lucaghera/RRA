 ...
 * 
 */
package org.rra.adaptationModel.m2t.handler;
...
import org.rra.adaptationModel.m2t.Activator;

public class AdaptationEngineTransformation extends AbstractHandler {
	
	public AdaptationEngineTransformation() {	
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (editor != null) {
            ...
            if (input instanceof IFileEditorInput) {
            	...
            	if(sourcefile.getFileExtension().compareTo("adaptationModel") != 0){
		...
		eglTransformParameter.setTransformName("Adaptation Engine generation");
		eglTransformParameter.setEglTransform(fileURL);
		eglTransformParameter.setPluginID(Activator.PLUGIN_ID);
		eglTransformParameter.setSourceMetaModelURI("http://www.rra.org/adaptationModel/AdaptationModelDSL");
