 ...
 * <ul>
 *   <li>{@link org.rra.dataTypesModel.impl.EnumElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumElementImpl extends MinimalEObjectImpl.Container implements EnumElement {
	...
	protected EClass eStaticClass() {
		return DataTypesModelPackage.Literals.ENUM_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesModelPackage.ENUM_ELEMENT__NAME, oldName, name));
	}
