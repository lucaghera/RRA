 ...
 * <ul>
 *   <li>{@link org.rra.dataTypesModel.impl.EnumeratorImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnumeratorImpl extends DataTypeImpl implements Enumerator {
	/**
	...
	protected EClass eStaticClass() {
		return DataTypesModelPackage.Literals.ENUMERATOR;
	}
	...
	public EList<EnumElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<EnumElement>(EnumElement.class, this, DataTypesModelPackage.ENUMERATOR__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataTypesModelPackage.ENUMERATOR__ELEMENTS:
